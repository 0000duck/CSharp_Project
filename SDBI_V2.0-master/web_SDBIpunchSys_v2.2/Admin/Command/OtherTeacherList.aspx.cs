...
public partial class Admin_TeacherList : System.Web.UI.Page
{
    ...
    {
        DataTable dt = BLL.AddSQLStringToDAL.RangeGetDatatableBySQL("Department,UserID,UserName,Role", "TabOtherTeachers", lim, limText);
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        DAL.ConnHELPer.ExecuteNoneQueryOperation("delete  from OtherTabTeachers where UserID='" + dataKeys+ "'");
        GVsource("1", "1");
    }
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        DAL.ConnHELPer.ExecuteNoneQueryOperation("  update OtherTabTeachers set Department='" + Department + "' where UserID='"+ UserID +"'"+
                                                 "  update OtherTabTeachers set UserID='" + UserID + "' where UserID='" + UserID + "'" +
                                                 "  update OtherTabTeachers set UserName='" + UserName + "' where UserID='" + UserID + "'" +
                                                 "  update OtherTabTeachers set Role='" + Role + "' where UserID='" + UserID + "'" 
                                                    );
        GridView1.EditIndex = -1;
        GVsource("1", "1");
