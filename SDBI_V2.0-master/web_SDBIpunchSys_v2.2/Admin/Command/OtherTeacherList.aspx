<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="OtherTeacherList.aspx.cs" Inherits="Admin_TeacherList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:softDBConnectionString %>" SelectCommand="SELECT [Department], [UserID], [UserName], [Role] FROM [TabTeachers]"></asp:SqlDataSource>
    </asp:Content>
