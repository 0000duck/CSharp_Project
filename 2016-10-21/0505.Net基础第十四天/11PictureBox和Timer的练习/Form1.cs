...
namespace _11PictureBox和Timer的练习
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            sp.SoundLocation = @"E:\壁纸\SoundTest.wav";
            sp.Play();
            ...
            pictureBox1.Image = Image.FromFile(@"E:\壁纸\test\1.jpg");
            pictureBox2.Image = Image.FromFile(@"E:\壁纸\test\1.jpg");
            pictureBox3.Image = Image.FromFile(@"E:\壁纸\test\1.jpg");
            pictureBox4.Image = Image.FromFile(@"E:\壁纸\test\1.jpg");
            pictureBox6.Image = Image.FromFile(@"E:\壁纸\test\1.jpg");
        }
        string[] path = System.IO.Directory.GetFiles(@"E:\壁纸\test");
        int i = 0;
        Random r = new Random();
